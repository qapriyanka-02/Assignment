...
public class RSA_Practise {
	...
	public void mouse_over() throws InterruptedException {
		...
		scroll_down();
		WebElement main_menu=driver.findElement(By.xpath("//button[@id='mousehover']"));
		WebElement sub_menu=driver.findElement(By.xpath("//a[text()='Top']"));
		WebElement sub_menu2=driver.findElement(By.xpath("//a[text()='Reload']"));
		Actions action = new Actions(driver);
		action.moveToElement(main_menu).perform();
		Thread.sleep(1000);
		action.moveToElement(sub_menu).click().perform();
		Thread.sleep(1000);
		scroll_down();
		action.moveToElement(main_menu).perform();
		action.moveToElement(sub_menu2).click().perform();
		System.out.println("Reloaded the page");
